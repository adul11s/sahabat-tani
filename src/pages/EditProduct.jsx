...
class PatchProduct extends Component {
  patchProd = async () => {
    await this.props.patchProduct();
...
export default connect(mapStateToProps, mapDispatchToProps)(PatchProduct);
